...
function Nav () {
    ...
    return(
        <div className="fixed top-0 w-full z-50 flex items-center justify-between px-6 py-4 bg-transparent">
            <a href='#topPage'><h1 className= "flex justify-end text-cyan-100 font-extrabold text-2xl">Blake Rears</h1></a>

            <div className='flex items-center gap-4'>
                <button className='flex items-center text-white border-2 border-white rounded-3xl px-2 py-1'>Resume | CV</button>
